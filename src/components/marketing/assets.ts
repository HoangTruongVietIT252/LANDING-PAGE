export const marketingAssets = {
  heroVideo:
    "https://videos.pexels.com/video-files/6724368/6724368-uhd_2560_1440_25fps.mp4",
  heroPoster:
    "https://images.pexels.com/photos/6621469/pexels-photo-6621469.jpeg?auto=compress&cs=tinysrgb&w=1600",
  concernImages: [
    "https://images.unsplash.com/photo-1617897903246-719242758050?auto=format&fit=crop&w=1200&q=80",
    "https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?auto=format&fit=crop&w=1200&q=80",
  ...
  solutionImages: [
    ...
    "https://images.unsplash.com/photo-1570194065650-d99fb4d8a7b0?auto=format&fit=crop&w=1200&q=80",
  ],
  blogFeatured:
