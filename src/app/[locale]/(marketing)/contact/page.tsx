...
const contactCards = [
  {
    icon: Mail,
    title: "Email support",
    description: "Reach out anytime for order questions, general inquiries, or help choosing where to start.",
    detail: "support@womenskinlabstore.com",
  },
  {
    icon: Clock3,
    title: "Response time",
    description: "We aim to reply within 1 to 2 business days so support feels clear, calm, and personal.",
    detail: "Monday to Friday, 9 AM to 5 PM",
  },
  {
    icon: MessageSquareHeart,
    title: "What we can help with",
    description: "Shipping questions, product guidance, routine direction, or general support before and after purchase.",
    detail: "Friendly, practical support",
  },
] as const;
    ...
    <main className="min-h-screen bg-[#fff8f3] text-[#241915]">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 md:grid-cols-[0.95fr_1.05fr] md:px-8 md:py-24">
          <div className="flex flex-col justify-center">
            <SectionIntro
              ...
              description="Whether you have a question about a product, need help with an order, or want a little guidance on where to begin, our team is here to help."
            />
            <p className="mt-6 max-w-2xl text-sm leading-7 text-[#6c5c52] md:text-base">
              Women Skin Lab is built to feel warm, clear, and easy to approach. Our support experience should feel the same.
            </p>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 md:grid-cols-[1fr_0.95fr] md:px-8 md:py-20">
          <Card className="rounded-[2rem] border-[#eadfd7] bg-[#fffdfb] shadow-none">
            <CardContent className="p-8 md:p-10">
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#9f7f67]">Send a message</p>
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-[#241915] md:text-4xl">
                Tell us how we can help.
              </h2>
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <Input className="h-12 rounded-full border-[#dbc9bd] bg-white px-5" placeholder="First name" />
                <Input className="h-12 rounded-full border-[#dbc9bd] bg-white px-5" placeholder="Last name" />
              </div>
              <Input className="mt-4 h-12 rounded-full border-[#dbc9bd] bg-white px-5" placeholder="Email address" />
              <Input className="mt-4 h-12 rounded-full border-[#dbc9bd] bg-white px-5" placeholder="Subject" />
              <Textarea
              ...
              <p className="mt-4 text-xs leading-6 text-[#7b665a]">
                ...
                <Link href="/privacy-policy" className="font-semibold text-[#241915] underline underline-offset-4">
                  Privacy Policy
                </Link>
                .
              </p>
          ...
          <div className="flex flex-col justify-center">
            <SectionIntro
              ...
              title="A support page should feel useful, not generic."
              description="We keep this experience simple so visitors know how to reach out, what to expect, and where to look for quick answers first."
            />
            <div className="mt-8 rounded-[1.75rem] border border-[#eadfd7] bg-[#fcf5ef] p-6 md:p-8">
              <p className="text-sm font-semibold text-[#241915]">Best contact method</p>
              <p className="mt-2 text-sm leading-7 text-[#5f5148]">Email support is the best way to reach us for questions about orders, products, or general guidance.</p>
              <p className="mt-5 text-sm font-semibold text-[#241915]">Response window</p>
              <p className="mt-2 text-sm leading-7 text-[#5f5148]">We typically respond within 1 to 2 business days.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-20">
        <SectionIntro
          ...
          description="These are the types of questions shoppers tend to have most often on beauty and skincare support pages."
        />
